...
// Source: C:/Users/de_Samuel/Documents/Projects/utmn-project/utmn-map-go-backend/internal/domain/map/service (interfaces: MapRepository)
//
// Generated by this command:
//
//	mockgen -destination=C:/Users/de_Samuel/Documents/Projects/utmn-project/utmn-map-go-backend/internal/domain/map/repository/mocks/mock_map_repository.go -package=mocks C:/Users/de_Samuel/Documents/Projects/utmn-project/utmn-map-go-backend/internal/domain/map/service MapRepository
//
...
// DeleteDoor mocks base method.
func (m *MockMapRepository) DeleteDoor(ctx context.Context, doorID uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteDoor", ctx, doorID)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteDoor indicates an expected call of DeleteDoor.
func (mr *MockMapRepositoryMockRecorder) DeleteDoor(ctx, doorID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteDoor", reflect.TypeOf((*MockMapRepository)(nil).DeleteDoor), ctx, doorID)
}
