...
func (m *MockMapRepository) DeletePolygonPoints(ctx context.Context, request entities.DeletePolygonPointsRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeletePolygonPoints", ctx, request)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeletePolygonPoints indicates an expected call of DeletePolygonPoints.
func (mr *MockMapRepositoryMockRecorder) DeletePolygonPoints(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePolygonPoints", reflect.TypeOf((*MockMapRepository)(nil).DeletePolygonPoints), ctx, request)
}
...
// GetPolygonByID mocks base method.
func (m *MockMapRepository) GetPolygonByID(ctx context.Context, id uuid.UUID) (entities.Polygon, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPolygonByID", ctx, id)
	ret0, _ := ret[0].(entities.Polygon)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetPolygonByID indicates an expected call of GetPolygonByID.
func (mr *MockMapRepositoryMockRecorder) GetPolygonByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// UpdatePolygon mocks base method.
func (m *MockMapRepository) UpdatePolygon(ctx context.Context, req entities.UpdatePolygonRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePolygon", ctx, req)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdatePolygon indicates an expected call of UpdatePolygon.
func (mr *MockMapRepositoryMockRecorder) UpdatePolygon(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePolygon", reflect.TypeOf((*MockMapRepository)(nil).UpdatePolygon), ctx, req)
}

// UpdatePolygonPoint mocks base method.
func (m *MockMapRepository) UpdatePolygonPoint(ctx context.Context, req entities.UpdatePolygonPointRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePolygonPoint", ctx, req)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdatePolygonPoint indicates an expected call of UpdatePolygonPoint.
func (mr *MockMapRepositoryMockRecorder) UpdatePolygonPoint(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePolygonPoint", reflect.TypeOf((*MockMapRepository)(nil).UpdatePolygonPoint), ctx, req)
}
