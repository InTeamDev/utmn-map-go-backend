...
func (m *MockMapRepository) DeletePolygonPoint(ctx context.Context, id int) error {
	m.ctrl.T.Helper()
...
func (m *MockMapRepository) DeletePolygonPoints(ctx context.Context, ids []int) error {
	m.ctrl.T.Helper()
